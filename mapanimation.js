...
const busStops = [
  ...
  const cargarClima = async () => {
    ...
    try{
      const respuesta = await fetch('https://api.openweathermap.org/data/2.5/weather?q=Boston&APPID=4300e49d7fb946ba46d00211b27dea6b');
      ...
      if (respuesta.status === 200){
        ...
        container.innerHTML = `<h3>This is the weather in Boston now:</h3> <p>${texto}</p>`;
